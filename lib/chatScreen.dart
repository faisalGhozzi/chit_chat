...
import 'package:chatnet/Voice.dart';
...
class Chat extends StatefulWidget {
  ...
  Chat({this.chatroomId, this.user, this.authUser});
...
class _ChatState extends State<Chat> {
  ...
  void onSendMessage() async {
    ...
    if (_message.text.isNotEmpty) {
      ...
      await _firestore
          .collection("Users")
          .doc(widget.authUser!.email!
              .trim()
              .substring(0, widget.authUser!.email!.trim().indexOf("@"))
              .toString())
          .set({"typingTo": ""}, SetOptions(merge: true));
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
                ...
                children: [
                  ...
                  StreamBuilder(
                      builder:
                        ...
                        if (snapshot.hasData) {
                          if (snapshot.data!.get("typingTo") ==
                              widget.authUser!.prenom) {
                            return Text(
                              "En train d'écrire...",
                      ...
                      stream: _firestore
                          ...
                          .doc(widget.user!.email!
                              .trim()
                              .substring(
                                  0, widget.user!.email!.trim().indexOf("@"))
                              .toString())
                          .snapshots())
                ],
              ),
        ...
        body: FutureBuilder<Widget>(
          future: _callState == SignalingState.CallStateIncoming
                              ...
                              .doc(widget.authUser!.email!
                                  ...
                                  .substring(
                                      ...
                                      widget.authUser!.email!
                                          ...
                                          .indexOf("@"))
                                  .toString())
                              .set({"typingTo": widget.user!.prenom},
  ...
  Future<Track> _createRemoteTrack(BuildContext context) async {
    ...
    if (ActiveCodec().codec != Codec.aacADTS) {
      ...
      track = Track(trackPath: audioUrl, codec: ActiveCodec().codec!);
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            VerticalSpacing(),
            DialUserPic(image: widget.user!.imageUrl),
            Flexible(
              child: Padding(
                ...
                RoundedButton(
                  ...
                  press: () async {
                    await signaling.joinRoom(
                        widget.chatroomId!, _remoteRenderer);
                  },
                  color: Colors.green,
  ...
  Widget messages(Size size, Map<String, dynamic> map, BuildContext context) {
    if (map['type'] == "message") {
      return Padding(
        padding: const EdgeInsets.all(8.0),
        child: Row(
          mainAxisAlignment: map['sendby'] == widget.authUser!.prenom
              ? MainAxisAlignment.end
              : MainAxisAlignment.start,
          crossAxisAlignment: map['sendby'] == widget.authUser!.prenom
              ? CrossAxisAlignment.end
              : CrossAxisAlignment.start,
          children: <Widget>[
            SizedBox(
                width: map['sendby'] == widget.authUser!.prenom ? 20.0 : 10.0),
            if (map['sendby'] != widget.authUser!.prenom) ...[
              CircleAvatar(
                backgroundImage: NetworkImage(
                  map['sendby'] == widget.authUser!.prenom
                ...
                children: <Widget>[
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: map['sendby'] == widget.authUser!.prenom
                          ? Colors.blue
                          : Colors.white,
                      borderRadius: map['sendby'] == widget.authUser!.prenom
                          ? BorderRadius.only(
